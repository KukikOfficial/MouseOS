...
${CC} ${CFLAGS} -c kernel/process.cpp -o build/obj/process.o

echo "Компоновка ядра..."
# Собираем все .o файлы в один бинарный файл ядра
${CC} ${LDFLAGS} -o build/iso/boot/myos.bin build/obj/boot.o build/obj/kernel.o build/obj/vga.o build/obj/keyboard.o build/obj/idt.o build/obj/fs.o build/obj/ata.o build/obj/memory.o build/obj/vesa.o build/obj/font.o build/obj/mouse.o build/obj/explorer.o build/obj/process.o
