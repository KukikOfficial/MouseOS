...
${CC} ${LDFLAGS} -o build/iso/boot/myos.bin build/obj/boot.o build/obj/kernel.o build/obj/vga.o build/obj/keyboard.o build/obj/idt.o build/obj/fs.o build/obj/ata.o build/obj/memory.o build/obj/vesa.o build/obj/font.o
